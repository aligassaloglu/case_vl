...
const SideBar = function() {
    ...
    return (
    <div className='min-h-screen px-5 py-9 max-md:hidden'>
        <div className=' bg-slate-600 h-full  flex flex-col gap-2 px-5 py-4 rounded-2xl drop-shadow-xl justify-center' style={{backgroundColor: "#BED8D4"}}>
            {sidebarData.map((el)=>(
